...
public final class LangfordsGenerator {
    ...
    public static void main(String[] args) {
        ...
        Help.saveAsFileWriter("//Langford, k = " + k + " n = " + n + "\r\n");

        int seqLength = k * n;
        Help.saveAsFileWriter("\r\n// Number of variables:\n" + seqLength + "\r\n");
        Help.saveAsFileWriter("\r\n// Domains of the variables: 1.. (inclusive)\r\n");
        // Variables are organised in n blocks of k, representing pos of each of the n
        // ints
        for (int i = 0; i < seqLength; i++)
            Help.saveAsFileWriter("1, " + seqLength + "\r\n");
        ...
        for (int block = 1; block <= n; block++)
            ...
            for (int i = 0; i < k; i++) {
                ...
                for (int j = block * k; j < seqLength; j++) {
                    Help.saveAsFileWriter("c(" + ((block - 1) * k + i) + ", " + j + ")\r\n");
