...
//    }
    ...
    /**
     * File format: <no. vars> NB vars indexed from 0 We assume that the domain of
     * all vars is specified in terms of bounds <lb>, <ub> (one per var) Then the
     * list of constraints c(<varno>, <varno>) binary tuples <domain val>, <domain
     * val>
     */
...
//            for (int i = 0; i < n; i++) {
//                System.out.print(domainBounds[i][0]);
//                System.out.print(domainBounds[i][1]);
//
//            }
            inFR.close();
            return csp;
